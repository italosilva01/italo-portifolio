...
const Conect = () => {
    ...
    return (
        <ContainerSection id='contact' className='w-full flex flex-col gap-y-6 justify-center lg:items-center'>
            ...
            />
            <div className="flex flex-col gap-4 mb-12 lg:gap-10 lg:flex-row lg:justify-center lg:my-[100px]">
